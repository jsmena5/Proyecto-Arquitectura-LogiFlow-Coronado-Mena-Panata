...
public class ClienteCreateRequest {
    ...
    @Pattern(regexp = "^([0-9]{10}|[0-9]{13})$", message = "La identificación debe ser un DNI válido (10 dígitos) o un RUC (13 dígitos)")
    ...
    @NotNull(message = "Debe especificar si el cliente es corporativo o no")
