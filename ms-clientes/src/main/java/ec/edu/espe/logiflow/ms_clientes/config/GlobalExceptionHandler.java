package ec.edu.espe.logiflow.ms_clientes.config;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleResponseStatus(ResponseStatusException ex) {
        ...
        body.put("error", "Error de Negocio - Clientes");
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrity(DataIntegrityViolationException ex) {
        ...
        // Un mensaje más genérico y profesional que cubre tanto crear duplicados como borrar padres con hijos
        body.put("message", "Operación rechazada: El registro ya existe o está siendo utilizado por otras entidades en el sistema.");
